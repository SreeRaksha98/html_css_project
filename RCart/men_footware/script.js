...
var fruitsArray = ['Brown Boots', 'Casual Shoes', 'Leather Shoes']
var imageArray = ['images/brown_boots.jpg', 'images/casual_shoes.jpg', 'images/leather_shoes.jpg']
...
fruitsArray.forEach((fruit, index) => {
    ...
    image.src = '/RCart/men_footware/' + imageArray[index] 
