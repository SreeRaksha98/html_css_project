...
var fruitsArray = ['Baggy Jeans', 'Blue and Dark Blue Jeans', 'Chudidar', 'Joggers', 'Sweater', 'White Anarkali']
var imageArray = ['images/baggy_jeans.webp', 'images/blueAnddarkblue_jeans.jpg', 'images/chudidar.jpg', 'images/joggers.jpg', 'images/sweater.jpg', 'images/white_anarkali.jpg']
...
fruitsArray.forEach((fruit, index) => {
    ...
    image.src = '/RCart/women_attire/' + imageArray[index] 
